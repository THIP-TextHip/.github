...
또한 취향 기반 추천(피드, 모임방, 책)을 통해 독서를 혼자 하는 활동이 아닌 **관계와 참여가 있는 문화 경험**으로 만들어갑니다.
...
실제 독서 지속률과 완독률은 여전히 낮은 상태에 머물러 있습니다.

THIP 팀은 이러한 문제의 원인을 파악하기 위해 20~30대 성인 109명을 대상으로 유저 리서치를 진행했고

그 결과 다음과 같은 한계를 도출했습니다.

**❌ 기존 독서 플랫폼의 한계**

- 완독 이후 리뷰 중심의 기록 구조로 인한 참여 장벽
- 정형화된 서평 작성 방식으로 발생하는 심리적 부담
- 시간·장소·참여 부담이 큰 오프라인 독서 모임 구조

⬆️ 해결방안??

- 완독 여부와 관계없이 페이지 단위로 가볍게 기록할 수 있는 구조
- 글·이미지, 투표 등 다양한 형식으로 부담 없이 독서 경험 공유
- 혼자 하는 독서가 아닌 함께하는 독서 경험으로 제공!
...
🏆 공모전 수상 <br/>
	•	과학기술정보통신부 주최 ‘한이음 드림업(ICT 멘토링) 공모전’ 입상 (장려) <br/>
	•	기획·개발·실제 서비스 구현까지의 완성도를 인정받아 수상 <br/>

🎖️ 지역사회 커뮤니티 지원사업 참여 <br/>
	•	서울 청년센터 광진(광진구청)에서 운영한 커뮤니티 지원사업 ‘진구친구’에 사회참여 모델로 참여 <br/>
	•	지역사회 문제(성인 독서량 감소) 해결을 위한 서비스 개발 및 운영에 기여 <br/>

🚀 실제 서비스 출시 및 운영 <br/>
	•	Android 앱 정식 출시 및 운영 <br/>
	  •	Google Play Store 등록 완료 <br/>
	  •	실제 사용자 다운로드 및 이용 가능 상태 <br/>
	•	웹 서비스 배포 및 운영 <br/>
	  •	공식 웹 서비스: https://www.thip.co.kr <br/>
	•	전용 랜딩 페이지 운영 <br/>
	  •	서비스 소개 및 사용자 유입, 반응 확인 용도 <br/>
    •	https://slashpage.com/thip <br/>
